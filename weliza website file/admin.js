...
const FS = (() => {
  ...
  async function exportAll(btn) {
    ...
    try {
      ...
      await Promise.all([savePurchases(), saveClients(), saveDealers(), saveExpenses(), saveInvoices()]);
  ...
  return { init, choose, createSubfolders, exportAll, updateLastExportNote, checkMonthlyReminder, savePurchases, saveClients, saveDealers, saveExpenses, saveInvoices };
})();
